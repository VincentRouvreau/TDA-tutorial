...
- RipsNet: based on a Deep Sets architecture, this Tensorflow model is a fast and robust estimation of persistent homology of point clouds. See [notebook](Tuto-GUDHI-ripsnet.ipynb).
